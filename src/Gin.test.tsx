...
import MediumComputer from './gin/ai/MediumComputer';
...
it('Registers computer player', () => {
  ...
  let computer2 = new MediumComputer();
  let computerControls2 = gin.addPlayer(computer2.listener.bind(computer2));
  computer2.registerHandlers(computerControls2)
